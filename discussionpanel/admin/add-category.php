                ...
                <div class="panel-heading">
                 ...
                 <div class="panel-body">
                   <form method="POST" action="add-category-function.php">
                        ...
                        <a href="category.php" class="btn btn-warning" style="margin-left: 85%;">Cancel</a>
        
                        <input type="submit" name="cat" class="btn btn-success pull-right" value="Add">
                   </form>
                </div>
    </div>
	</body>
